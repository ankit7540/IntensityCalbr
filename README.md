...
|--------------------------------------|---------------------------|-------------------------------------|-------------------------|---------------------------|
| Pure rotational Raman intensities    | t-dependent](o)           | t-independent                       |                         |                           |
| Vibration-rotation Raman intensities | [t-dependent](o)          | t-independent                       | common rotational state | temperature determination |
