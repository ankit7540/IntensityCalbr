...
# Set logging ------------------------------------------
fileh = logging.FileHandler('./log_afterC2.txt', 'w+')
...
dataD2_O2S0 = np.loadtxt("./run_parallel_afterC2/BA_D2_O_2_S_0.txt")
dataD2_O3S1 = np.loadtxt("./run_parallel_afterC2/BA_D2_O_3_S_1.txt")

dataHD_O2S0 = np.loadtxt("./run_parallel_afterC2/BA_HD_O_2_S_0.txt")
dataHD_O3S1 = np.loadtxt("./run_parallel_afterC2/BA_HD_O_3_S_1.txt")
# ------------------------------------------------------
