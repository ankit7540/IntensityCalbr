...
# Set logging ------------------------------------------
fileh = logging.FileHandler('./log_woC2.txt', 'w+')
...
dataD2Q = np.loadtxt("./run_parallel_woC2/BA_D2_q1.txt")
dataHDQ = np.loadtxt("./run_parallel_woC2/BA_HD_q1.txt")
dataH2Q = np.loadtxt("./run_parallel_woC2/BA_H2_q1.txt")

# individual pairs -------------------------------------

dataD2_O2S0 = np.loadtxt("./run_parallel_woC2/BA_D2_O_2_S_0.txt")
dataD2_O3S1 = np.loadtxt("./run_parallel_woC2/BA_D2_O_3_S_1.txt")

dataHD_O2S0 = np.loadtxt("./run_parallel_woC2/BA_HD_O_2_S_0.txt")
dataHD_O3S1 = np.loadtxt("./run_parallel_woC2/BA_HD_O_3_S_1.txt")
# ------------------------------------------------------
