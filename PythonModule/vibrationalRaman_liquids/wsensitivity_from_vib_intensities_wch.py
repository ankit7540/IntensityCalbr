...
data_CCl4 = np.loadtxt("./expt_data_phe/BA_CCl4.txt")
data_C6H6 = np.loadtxt("./expt_data_phe/BA_C6H6.txt")
data_C6H12 = np.loadtxt("./expt_data_phe/BA_C6H12.txt")
xaxis = np.loadtxt("./expt_data_phe/Wavenumber_axis_pa.txt")

# ------------------------------------------------------

# Reference data
# Change following paths
ref_CCl4 = np.loadtxt("./expt_data_phe/BA_ref_CCl4.txt")
ref_C6H6 = np.loadtxt("./expt_data_phe/BA_ref_C6H6.txt")
ref_C6H12 = np.loadtxt("./expt_data_phe/BA_ref_C6H12.txt")
