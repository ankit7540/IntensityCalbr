...
dataH2 = np.loadtxt("./run_parallel_rem2/BA_H2_1.txt")
dataHD = np.loadtxt("./run_parallel_rem2/BA_HD_1.txt")
dataD2 = np.loadtxt("./run_parallel_rem2/BA_D2_1.txt")
xaxis = np.loadtxt("./run_parallel_rem2/Ramanshift_axis_para.txt")
# ------------------------------------------------------
