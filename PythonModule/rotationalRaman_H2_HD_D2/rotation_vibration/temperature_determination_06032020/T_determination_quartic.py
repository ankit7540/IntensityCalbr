...
# Set logging ------------------------------------------
fileh = logging.FileHandler('./log_afterC2_quartic.txt', 'w+')
...
# note the J values which are included 

dataD2Q = np.loadtxt("./run_parallel_afterC2_quartic/BA_D2_q1.txt")
dataHDQ = np.loadtxt("./run_parallel_afterC2_quartic/BA_HD_q1.txt")
dataH2Q = np.loadtxt("./run_parallel_afterC2_quartic/BA_H2_q1.txt")

# individual pairs -------------------------------------

dataD2_O2S0 = np.loadtxt("./run_parallel_afterC2_quartic/BA_D2_O_2_S_0.txt")
dataD2_O3S1 = np.loadtxt("./run_parallel_afterC2_quartic/BA_D2_O_3_S_1.txt")

dataHD_O2S0 = np.loadtxt("./run_parallel_afterC2_quartic/BA_HD_O_2_S_0.txt")
dataHD_O3S1 = np.loadtxt("./run_parallel_afterC2_quartic/BA_HD_O_3_S_1.txt")
# ------------------------------------------------------
...
def run_fit():
    ...
    run_fit_D2_O2S0( inputT )
    run_fit_D2_O3S1( inputT )
    
    run_fit_HD_O2S0( inputT )
    run_fit_HD_O3S1( inputT )
    run_fit_D2_234( inputT )
...
def residual_Q_D2_234(param):
    ...
    #print(computed_D2)  // remove the first two data points
    computed_D2=computed_D2[:-2, :]
    #print(computed_D2)
    
    dataD2Q_sub = dataD2Q[:-2, :]
    #print(computed_D2.shape, dataD2Q_sub.shape)
    
    trueR_D2 = gen_intensity_mat(computed_D2, 2)
    expt_D2 = gen_intensity_mat(dataD2Q_sub, 0)
...
def residual_Q_H2(param):
    ...
    #print(expt_H2.shape, calc_H2.shape)
    # ----------------
...
def residual_O2S0_D2(param):
    ...
    r_expt = (dataD2_O2S0 [0]/dataD2_O2S0 [1])
    #print(r_calc, r_expt)
...
def residual_O3S1_D2(param):
    ...
    TK = param
    sosD2 = compute_series_para.sumofstate_D2(TK)
    O1 = compute_series_para.D2_O1(TK, 3, sosD2)
    S1 = compute_series_para.D2_S1(TK, 1, sosD2)
    ...
    r_expt = (dataD2_O3S1 [0]/ dataD2_O3S1 [1])
    #print(r_calc, r_expt)
...
def residual_O2S0_HD(param):
    ...
    TK = param
    sosHD = compute_series_para.sumofstate_HD(TK)
    O1 = compute_series_para.HD_O1(TK, 2, sosHD)
    S1 = compute_series_para.HD_S1(TK, 0, sosHD)
    ...
    r_expt = ( dataHD_O2S0 [0]/ dataHD_O2S0 [1])
    #print(r_calc, r_expt)
...
def residual_O3S1_HD(param):
    ...
    TK = param
    sosHD = compute_series_para.sumofstate_HD(TK)
    O1 = compute_series_para.HD_O1(TK, 3, sosHD)
    S1 = compute_series_para.HD_S1(TK, 1, sosHD)
    ...
    r_expt = ( dataHD_O3S1 [0]/ dataHD_O3S1 [1])
    #print(r_calc, r_expt)
...
def run_fit_D2_O3S1(init_T ):
    ...
    #print("Testing the residual function with data")
    print("Initial coef :  T={0},   output = {1}".format(init_T, \
          (residual_O3S1_D2(param_init))))


    print("\nOptimization run: D2, O3S1     \n")
    res = opt.minimize(residual_O3S1_D2, param_init, method='Nelder-Mead', \
                              options={'xatol': 1e-9, 'fatol': 1e-9})
...
def run_fit_HD_O2S0(init_T ):
    ...
    #print("Testing the residual function with data")
    print("Initial coef :  T={0},   output = {1}".format(init_T, \
          (residual_O2S0_HD(param_init))))

    print("\nOptimization run: HD, O2S0     \n")
    res = opt.minimize(residual_O2S0_HD, param_init, method='Nelder-Mead', \
                              options={'xatol': 1e-9, 'fatol': 1e-9})
...
def run_fit_HD_O3S1(init_T ):
    ...
    #print("Testing the residual function with data")
    print("Initial coef :  T={0},   output = {1}".format(init_T, \
          (residual_O3S1_HD(param_init))))


    print("\nOptimization run: HD, O3S1     \n")
    res = opt.minimize(residual_O3S1_HD, param_init, method='Nelder-Mead', \
                              options={'xatol': 1e-9, 'fatol': 1e-9})
